...
var _user$project$Main$getToasterHtml = function (pageData) {
	var _p0 = _elm_lang$core$String$length(pageData.toasterMsg);
	if (_p0 === 0) {
		return A2(
		...
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$borderStyle(_rtfeldman$elm_css$Css$dashed),
						_1: {
							ctor: '::',
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text(pageData.toasterMsg),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$Main$doneMessage = function (pageData) {
	var _p1 = pageData.loading;
	if (_p1 === true) {
		return 'Loading';
	} else {
		return 'Done';
...
var _user$project$Main$selectedColor = function (subject) {
	var _p2 = subject.current;
	if (_p2 === true) {
		return _rtfeldman$elm_css$Css$hex('add8e6');
	} else {
		return _rtfeldman$elm_css$Css$hex('ffffff');
	}
};
var _user$project$Main$studyEntryToHtml = function (studyEntry) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text(studyEntry.date),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _rtfeldman$elm_css$Html_Styled$text(
							A2(_elm_lang$core$Basics_ops['++'], ': ', studyEntry.description)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$Subject = F5(
	function (a, b, c, d, e) {
		return {name: a, daysSinceLast: b, timeAlreadyInvested: c, history: d, current: e};
	});
var _user$project$Main$decodeSubject = A2(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'name',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Subject))))));
var _user$project$Main$decodeSubjectList = _elm_lang$core$Json_Decode$list(_user$project$Main$decodeSubject);
var _user$project$Main$StudyEntry = F3(
	function (a, b, c) {
		return {date: a, description: b, subjectName: c};
	});
var _user$project$Main$decodeStudyEntry = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'subject',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'date',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$StudyEntry))));
var _user$project$Main$decodeSubjectHistory = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'history',
	...
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeStudyEntry));
var _user$project$Main$PageData = F3(
	function (a, b, c) {
		return {subjects: a, loading: b, toasterMsg: c};
	});
var _user$project$Main$Done = {ctor: 'Done'};
var _user$project$Main$GetDetail = function (a) {
	return {ctor: 'GetDetail', _0: a};
};
var _user$project$Main$getDetail = function (subject) {
	var url = A2(_elm_lang$core$Basics_ops['++'], 'http://whatnext:5000/detail/', subject.name);
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Main$decodeSubjectHistory);
	return A2(_elm_lang$http$Http$send, _user$project$Main$GetDetail, request);
};
		...
		switch (_p3.ctor) {
			case 'NewList':
				if (_p3._0.ctor === 'Err') {
					...
					return {
						ctor: '_Tuple2',
						_0: A3(_user$project$Main$PageData, _p3._0._0, false, ''),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'ExpandSubject':
				var _p4 = _elm_lang$core$List$head(model.subjects);
				if (_p4.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$getDetail(_p4._0)
					};
				} else {
			...
			case 'GetDetail':
				if (_p3._0.ctor === 'Ok') {
					var _p5 = model.subjects;
					if (_p5.ctor === '::') {
						var listHead = _elm_lang$core$Native_Utils.update(
							_p5._0,
							{history: _p3._0._0});
						...
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{
								subjects: {ctor: '::', _0: newHead, _1: _p5._1}
							});
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								toasterMsg: _elm_lang$core$Basics$toString(_p3._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Main$ExpandSubject = {ctor: 'ExpandSubject'};
var _user$project$Main$subjectToHtml = function (subject) {
	var color = _user$project$Main$selectedColor(subject);
	var detailHtml = A2(_elm_lang$core$List$map, _user$project$Main$studyEntryToHtml, subject.history);
	return A2(
		_rtfeldman$elm_css$Html_Styled$li,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$ExpandSubject),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
					...
					_0: _rtfeldman$elm_css$Html_Styled$text(
						A2(
							...
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(subject.daysSinceLast),
									A2(
										_elm_lang$core$Basics_ops['++'],
										' days ago -  ',
										_elm_lang$core$Basics$toString(subject.timeAlreadyInvested)))))),
					_1: {
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$div,
...
var _user$project$Main$subjectsToHtml = function (list) {
	var innerList = A2(_elm_lang$core$List$map, _user$project$Main$subjectToHtml, list);
	return A2(
...
var _user$project$Main$view = function (pageData) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$getToasterHtml(pageData),
					_1: {
						ctor: '::',
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$div,
							...
							{
								ctor: '::',
								_0: _user$project$Main$subjectsToHtml(pageData.subjects),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$NewList = function (a) {
	return {ctor: 'NewList', _0: a};
};
var _user$project$Main$getList = function () {
	var url = 'http://whatnext:5000';
	var request = A2(_elm_lang$http$Http$get, url, _user$project$Main$decodeSubjectList);
	return A2(_elm_lang$http$Http$send, _user$project$Main$NewList, request);
}();
